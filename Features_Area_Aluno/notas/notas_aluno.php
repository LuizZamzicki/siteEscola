<?php
FuncoesUtils::adicionarJs('Features_Area_Aluno/notas/notas_aluno.js');
?>
<script>
    // Dados estáticos de exemplo para as notas, permitindo que o gráfico e a tabela funcionem.
    // A variável `studentData` é usada pelo script `area_aluno.js`.
    ...
    studentData.grades = {
        ...
        "4": [] // Bimestre ainda sem notas para demonstração
    };
</script>
