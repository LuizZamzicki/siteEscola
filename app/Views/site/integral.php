<?php
// A view espera receber $faq_integral, $itinerarios, $contato, $link_desempenho_integral_pr já preparados pelo controller.
?>
        ...
        <div class="col-lg-8 col-md-10">
            <div class="card-padrao p-4">
                <div class="accordion" id="faqAccordion">
                    <?php foreach ($faq_integral as $index => $item): ?>
