...
use Core\Database;
use App\Models\DTO\CardapioDTO;
use PDOException;
...
class CardapioService
{
    ...
    public function salvar(CardapioDTO $cardapio): array
    {
        try
        {
            ...
            {
                // Atualizar
                $sql = "UPDATE cardapios SET data = :data, lanche_manha = :lanche_manha, almoco = :almoco, lanche_tarde = :lanche_tarde
WHERE id_cardapio = :id";
            ...
            {
                // Inserir
                $sql = "INSERT INTO cardapios (data, lanche_manha, almoco, lanche_tarde) VALUES (:data, :lanche_manha, :almoco,
:lanche_tarde)";
                $params = [
                ':data' => $cardapio->data,
                ':lanche_manha' => $cardapio->lanche_manha,
