...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    {
        $evento = new EventoCalendarioDTO(
        ...
        $feedbackMessage = $eventoService->salvar($evento) ? "Evento salvo com sucesso!" : "Erro ao salvar evento.";
    }

    if ($action === 'excluir_evento')
    {
        $id = (int)$_POST['event-id-delete'];
        $feedbackMessage = $eventoService->excluir($id) ? "Evento excluído com sucesso!" : "Erro ao excluir evento.";
    }
...
// Busca os eventos para passar para o JavaScript
$eventosDoBanco = $eventoService->buscarTodos();
