...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    if ($action === 'salvar_aluno')
    {
        ...
        $feedbackMessage = $usuarioService->salvar($alunoDTO) ? "Aluno salvo com sucesso!" : "Erro ao salvar aluno.";
    }

    if ($action === 'desativar_aluno')
    {
        $id = (int)$_POST['deactivate-student-id'];
        $feedbackMessage = $usuarioService->desativar($id) ? "Aluno desativado com sucesso!" : "Erro ao desativar aluno.";
    }
...
$alunos = $usuarioService->buscarTodosAlunos();
