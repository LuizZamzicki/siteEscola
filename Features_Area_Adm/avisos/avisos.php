<?php
require_once BASE_PATH . 'core/services/AvisoService.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    if ($action === 'salvar_aviso')
    {
        ...
        $feedbackMessage = $avisoService->salvar($avisoDTO) ? "Aviso salvo com sucesso!" : "Erro ao salvar o aviso.";
    ...
    if ($action === 'excluir_aviso')
    {
        ...
        $feedbackMessage = $avisoService->excluir($id) ? "Aviso excluído com sucesso!" : "Erro ao excluir o aviso.";
        if (strpos($feedbackMessage, 'Erro') !== false)
            $feedbackType = 'error';
    }
...
$avisos = $avisoService->buscarTodos();
...
FuncoesUtils::adicionarJs('Features_Area_Adm/avisos/avisos.js');
?>
